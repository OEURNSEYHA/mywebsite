        ...
        <div className="w-[100%] md:w-[30%] lg:w-[20%] h-fit bg-white rounded-[10px] overflow-hidden shadow-sm">
          <div className="h-[250px] relative">
            ...
            <div className="absolute left-0 top-0 w-full h-full bg-[#00000020] flex flex-row gap-3 items-end justify-end p-5 ">
              < Link to = {`https://www.facebook.com/seyha.oeun`} target="blang" className="w-[30px] h-[30px] bg-white rounded-full flex justify-center items-center text-blue-800 text-[20px]">
                <FaFacebookF />
              </Link>
              <Link to={`https://t.me/oeurnseyha`} target="blang" className="w-[30px] h-[30px] bg-white rounded-full flex justify-center items-center text-blue-800 text-[20px]">
